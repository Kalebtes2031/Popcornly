          ...
          <View className="flex-1 justify-between py-2">
            <View>
              ...
              <View className="flex-row items-center mb-1">
                <View
                  className={`px-2 py-1 rounded-full mr-2 ${item.type === "movie"
                    ? "bg-blue-500/20"
                    : "bg-purple-500/20"
                    }`}
                >
                  <Text
                    className={`text-xs ${item.type === "movie"
                      ? "text-blue-400"
                      : "text-purple-400"
                      }`}
                  >
          ...
          <View className=" ">
            ...
            {loadingTrending ? (
              <FlashList
                ...
                data={[1, 2, 3, 4, 5, 6]}
                keyExtractor={(item: any) => `skeleton-movie-${item}`}
          ...
          <View className=" mt-4">
            ...
            {loadingTrending ? (
              <FlashList
                ...
                showsHorizontalScrollIndicator={false}
                data={[1, 2, 3, 4, 5, 6]}
                keyExtractor={(item: any) => `skeleton-tv-${item}`}
                renderItem={() => <SkeletonLoader />}
                contentContainerStyle={{ paddingHorizontal: 20 }}
              />
            ) : (
